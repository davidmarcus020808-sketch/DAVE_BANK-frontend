...
const LogoutPage = () => {
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-b from-black via-[#0a0a0a] to-black text-yellow-50 p-6 md:p-12 flex flex-col"
    ...
    >
      ...
      {/* Main Content */}
      <main className="max-w-5xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1">
        {/* Left Section: Profile & Actions */}
        <section className="col-span-1 bg-white/5 backdrop-blur-lg border border-yellow-700/20 rounded-2xl p-6 flex flex-col gap-4 shadow-[0_0_20px_rgba(255,215,0,0.04)]">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-xl bg-yellow-600 flex items-center justify-center text-black text-lg font-bold">
              DM
            </div>
            <div>
          ...
          <div className="mt-4 border-t border-yellow-700/20 pt-4">
            <p className="text-xs text-yellow-200/70 mb-2">Security tip</p>
        ...
        <section className="lg:col-span-2 space-y-6">
          {/* Active Devices */}
          <div className="bg-white/5 backdrop-blur-lg border border-yellow-700/20 rounded-2xl p-6 shadow-sm">
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    {d.current ? (
                      ...
                      <button
                        className="text-xs text-yellow-300/90 hover:text-yellow-200 transition px-3 py-1 rounded-md border border-yellow-800/20"
                        onClick={() =>
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-yellow-700/20 rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-xl border border-yellow-800/10 bg-yellow-900/10">
                <div className="flex items-center gap-3">
                  <Clock size={18} className="text-yellow-300" />
                  <div>
                    <p className="text-sm text-yellow-100 font-medium">Login</p>
                    <p className="text-xs text-yellow-200/70">
